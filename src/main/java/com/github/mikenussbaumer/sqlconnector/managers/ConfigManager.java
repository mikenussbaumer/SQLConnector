...
public class ConfigManager< T > {
    ...
    private void loadConfig ( boolean reload ) {
        // Info message
        System.out.println( "[POS-Client] Loading " + file.getName( ) + " config.." );
        ...
        try {
            ...
            // Info message
            System.out.println( this.settings != null ? "[POS-Client] Loaded " + file.getName( ) + "!" : "[POS-Client] Loaded file but settings is null" );
            ...
            System.out.println( "[POS-Client] Failed to load " + file.getName( ) + " config!" );
